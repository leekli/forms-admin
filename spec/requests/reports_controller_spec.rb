...
RSpec.describe ReportsController, type: :request do
  ...
  describe "csv downloads" do
    ...
    describe "#live_forms_csv" do
      ...
      let(:expected_csv_filename) { "live_forms_report-2025-05-15--15-31-57.csv" }
    ...
    describe "#forms_with_routes as csv" do
      ...
      let(:expected_csv_filename) { "live_forms_with_routes_report-2025-05-15--15-31-57.csv" }
    ...
    describe "#forms_with_payments as csv" do
      let(:form) { create(:form, :live, payment_url: "https://www.gov.uk/payments/organisation/service") }
      let(:forms) { [form, *create_list(:form, 2, :live)] }
      let(:expected_csv_filename) { "live_forms_with_payments_report-2025-05-15--15-31-57.csv" }
    ...
    describe "#forms_with_csv_submission_enabled as csv" do
      let(:form) { create(:form, :live, submission_type: "email", submission_format: %w[csv]) }
      let(:forms) { [form, *create_list(:form, 2, :live)] }
      let(:expected_csv_filename) { "live_forms_with_csv_submission_email_attachments_report-2025-05-15--15-31-57.csv" }
    ...
    describe "#forms_with_copy_of_answers_enabled as csv" do
      let(:form) { create(:form, :live, send_copy_of_answers: "enabled") }
      let(:forms) { [form, *create_list(:form, 2, :live)] }
      let(:expected_csv_filename) { "live_forms_with_copy_of_answers_enabled_report-2025-05-15--15-31-57.csv" }
    ...
    describe "#live_questions_csv" do
      ...
      let(:expected_csv_filename) { "live_questions_report-2025-05-15--15-31-57.csv" }
    ...
    describe "#questions_with_answer_type as csv" do
      ...
      let(:forms) { [form, *create_list(:form, 2, :live)] }
      let(:expected_csv_filename) { "live_questions_report_text_answer_type-2025-05-15--15-31-57.csv" }
    ...
    describe "#questions_with_add_another_answer as csv" do
      ...
      let(:forms) { [form, *create_list(:form, 2, :live)] }
      let(:expected_csv_filename) { "live_questions_with_add_another_answer_report-2025-05-15--15-31-57.csv" }
